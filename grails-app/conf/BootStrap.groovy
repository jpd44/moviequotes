...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        Moviequote moviequote2=new Moviequote(movie:"-",quote:"\"Let off some steam, Benett!\"", role:"Matrix");
        Moviequote moviequote3=new Moviequote(movie:"-",quote:"\"He's been... trained to eat things that would make a billgoat puke.\"", role:"Colonel Trautman");
